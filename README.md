...
сессиях, оформлением заказов и админ-панелью. Уникальный дизайн —
тёмная неоновая тема с glassmorphism и анимациями, без CSS-фреймворков.
...
- **Дизайн и анимации** — неоновая тема, reveal-on-scroll, parallax-орбита
  в hero, tilt-эффект карточек, анимированные счётчики, glassmorphism,
  кастомный мобильный бургер без CSS-фреймворков

## Стек

Python 3.13 · Django 6.1 · SQLite · HTML/CSS/JS (чистый CSS, без Bootstrap) · Pillow
